...
DOCUMENTATION = r"""
---
module: aci_external_management_consumed_contract
...
- name: Add a Consumed Contract
  cisco.aci.aci_external_management_consumed_contract:
    host: apic
    username: admin
...
def main():
    ...
    module = AnsibleModule(
        ...
        required_if=[
            ["state", "absent", ["instance_profile", "consumed_contract"]],
            ["state", "present", ["instance_profile", "consumed_contract"]],
        ],
    )
